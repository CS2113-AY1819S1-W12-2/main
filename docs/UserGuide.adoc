...
* If the deletion of a contact results in your own contact being the only person left in the group, the group will be
 automatically deleted. This deletion will also be reflected in the command result in addition to the people who were
  deleted and the groups affected by their deletion.
****
